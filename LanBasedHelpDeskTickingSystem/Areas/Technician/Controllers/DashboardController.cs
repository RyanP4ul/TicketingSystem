...
public class DashboardController(IAdminDashboardRepository adminDashboardRepository, ICategoryRepository categoryRepository, ITicketRepository ticketRepository) : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        return View("Technician/Index", new AdminViewModel
        {
